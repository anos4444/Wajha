...
API.applyPrefs({
    ...
    primary: "#06b6d4",
    secondary: "#0891b2",
    theme_css: "/assets/wajha/css/themes/ocean-depth.css",
    density: "Comfortable",
});
...
check("stylesheet <link> created with the preset href",
    themeLink() && themeLink().getAttribute("href") === "/assets/wajha/css/themes/ocean-depth.css",
...
API.applyPrefs({
    ...
    primary: "#ef4444",
    secondary: "#dc2626",
    theme_css: "/assets/wajha/css/themes/crimson-red.css",
});
check("href retargeted to the new preset",
    themeLink() && themeLink().getAttribute("href") === "/assets/wajha/css/themes/crimson-red.css",
    themeLink() && themeLink().getAttribute("href"));
...
API.applyPrefs({
    ...
    theme_css: "/assets/wajha/css/themes/swift-blue.css",
});
...
API.applyPrefs({
    ...
    theme_css: "/assets/wajha/css/themes/black-panther.css",
    roles: {
...
API.applyPrefs({
    ...
    theme_css: "/assets/wajha/css/themes/venom.css",
...
(function returningVisitorBoots() {
    ...
    const saved = {
        ...
        swift_themeCss: "/assets/wajha/css/themes/iron-man.css",
