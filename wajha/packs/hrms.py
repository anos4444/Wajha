...
MODULES = [
    ("my_leaves", "إجازاتي", "My Leave", "fa-umbrella-beach", "Leave Application", 1,
    ...
    ("my_checkins", "تسجيل الحضور", "Check In / Out", "fa-location-dot", "Employee Checkin", 2,
     "Mine (Employee Field)", "employee", {
         ...
         "actions": [
             {"label": "تسجيل دخول", "label_en": "Check in", "action_type": "Create", "level": "Module",
              "style": "Primary", "confirm": 1, "icon": "fa-right-to-bracket",
             ...
             {"label": "تسجيل خروج", "label_en": "Check out", "action_type": "Create", "level": "Module",
              "style": "Danger", "confirm": 1, "icon": "fa-right-from-bracket",
              "value": {"log_type": "OUT", "time": "{now}", "latitude": "{lat}", "longitude": "{lon}", "device_id": "wajha-shell"}},
         ],
     }),
    ("my_salary_slips", "قسائم راتبي", "My Salary Slips", "fa-money-check-dollar", "Salary Slip", 3,
     "Mine (Employee Field)", "employee", {
