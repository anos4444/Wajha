...
# _versioned() appends a content hash so a deploy never leaves a browser on
# the previous stylesheet. Only the shell's own files load Desk-wide; the
# Swift Theme module and its 26 Desk-wide assets were removed in 0.17.0.
app_include_css = [
